 ...
 */
public abstract class ActivityYS extends RoboSherlockFragmentActivity {
    long exitTime = 0;
    ...
    protected void progressDialogShow(Activity activity, boolean cancelable) {
        progressDialogDismiss();
        progressDialog = ProgressDialog.show(activity, "", "正在拼命读取中...", true, cancelable);
        progressDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
            @Override
            public void onCancel(DialogInterface dialogInterface) {
                progressDialogDismiss();
