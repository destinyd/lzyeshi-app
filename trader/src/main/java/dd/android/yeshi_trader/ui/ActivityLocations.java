...
////        OverlayItemSelectLocation poiOverlay = new OverlayItemSelectLocation(this, mMapView);
...
//            }
    ...
    private void locations_to_view() {
        ...
        mMapView.getOverlays().add(new OverItemLocations(marker, mMapView, locations)); //添加ItemizedOverlay实例到mMapView
